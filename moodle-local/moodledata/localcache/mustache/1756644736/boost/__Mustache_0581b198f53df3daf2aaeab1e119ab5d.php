...
class __Mustache_0581b198f53df3daf2aaeab1e119ab5d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section110d810fd16a8e87d18b2dfe595d592c($context, $indent, $value);
    ...
    private function section4e9887015e8be3b5f944946c5e8591f5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                <div class="custom-control custom-radio mb-2">
                    <input
                        ...
                        value="{{value}}"
                    >
                    <label class="custom-control-label ms-2" for="block-noncontacts-{{uniqid}}-{{value}}">
                        {{text}}
                    </label>
                </div>
            ';
...
';
                $buffer .= $indent . '                    >
';
                $buffer .= $indent . '                    <label class="custom-control-label ms-2" for="block-noncontacts-';
                $value = $this->resolveValue($context->find('uniqid'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '-';
                $value = $this->resolveValue($context->find('value'), $context);
...
';
    ...
    private function section110d810fd16a8e87d18b2dfe595d592c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
<div data-region="settings" class="p-3">
    ...
    <div class="hidden" data-region="notification-preference-container" role="group" aria-labelledby="notification-preferences-header-{{uniqid}}">
        <h3 class="mb-2 mt-4 h6 font-weight-bold" id="notification-preferences-header-{{uniqid}}">{{#str}} notificationpreferences, core_message {{/str}}</h3>
    </div>
...
';
                ...
                $buffer .= $this->section4e9887015e8be3b5f944946c5e8591f5($context, $indent, $value);
                $buffer .= $indent . '        </fieldset>
';
                $buffer .= $indent . '    </div>
';
...
';
                ...
                $buffer .= '">
';
                $buffer .= $indent . '        <h3 class="mb-2 mt-4 h6 font-weight-bold" id="notification-preferences-header-';
                $value = $this->resolveValue($context->find('uniqid'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">';
                $value = $context->find('str');
