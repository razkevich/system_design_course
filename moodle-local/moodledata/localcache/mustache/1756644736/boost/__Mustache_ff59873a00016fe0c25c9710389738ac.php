...
class __Mustache_ff59873a00016fe0c25c9710389738ac extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'containerattributes' => array($this, 'block28f0348cd101168be4bf35e2e1a9e09f'),
                ...
                'headeractions' => array($this, 'blockC7da0a072979097633263bce719d5fc1'),
    ...
    private function sectionDee494eca726473d1b3efc8f73edb3ea(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block28f0348cd101168be4bf35e2e1a9e09f($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockC7da0a072979097633263bce719d5fc1($context)
    {
        $indent = $buffer = '';
...
';
        ...
        $buffer .= $this->sectionDee494eca726473d1b3efc8f73edb3ea($context, $indent, $value);
