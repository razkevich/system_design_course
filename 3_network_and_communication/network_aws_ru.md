...
![Иерархия сетей AWS](aws_networking_hierarchy.svg)
...
![Маршрутизация в Интернете](internet_routing.svg)
...
![Методы подключения VPC](vpc_connectivity.svg)
### VPN-подключение
...
![VPN-подключение](vpn_connectivity.svg)
